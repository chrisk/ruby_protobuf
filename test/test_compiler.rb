...
class CompilerTest < Test::Unit::TestCase
  ...
  def test_compile_float_default
    assert_compile_proto <<-eos, 'test/fixtures/proto/float_default.proto'
### Generated by rprotoc. DO NOT EDIT!
### <proto file: test/fixtures/proto/float_default.proto>
...
class M < ::Protobuf::Message
  ...
  def test_create_message
    assert_compile_proto <<-eos, 'test/fixtures/proto/addressbook.proto'
### Generated by rprotoc. DO NOT EDIT!
### <proto file: test/fixtures/proto/addressbook.proto>
# package tutorial;
# 
# message Person {
...
module Tutorial
  ...
  def test_create_nested_message
    assert_compile_proto <<-eos, 'test/fixtures/proto/nested.proto'
### Generated by rprotoc. DO NOT EDIT!
### <proto file: test/fixtures/proto/nested.proto>
# message Foo {  
#   message Bar {
#   } 
# }
...
class Baaz < ::Protobuf::Message
  ...
  def test_nested_message
    ...
    file_contents = Protobuf::Compiler.new.create_message('test/fixtures/proto/nested.proto', '.', '.', false)
  ...
  def test_create_rpc
    file_contents = Protobuf::Compiler.new.create_rpc('test/fixtures/proto/rpc.proto', '.', '.', false)

    assert_source <<-eos, file_contents['./test/fixtures/proto/address_book_service.rb']
require 'protobuf/rpc/server'
require 'protobuf/rpc/handler'
require 'test/fixtures/proto/rpc.pb'
...
class Tutorial::AddressBookService < Protobuf::Rpc::Server
  def setup_handlers
    ...
    assert_source <<-eos, file_contents['./test/fixtures/proto/start_address_book_service']
#!/usr/bin/env ruby
...
Tutorial::AddressBookService.new(:port => 9999).start
    ...
    assert_source <<-eos, file_contents['./test/fixtures/proto/client_search.rb']
#!/usr/bin/env ruby
...
puts response
    ...
    assert_source <<-eos, file_contents['./test/fixtures/proto/client_add.rb']
#!/usr/bin/env ruby
require 'protobuf/rpc/client'
require 'test/fixtures/proto/rpc.pb'
...
puts response
  ...
  def test_create_descriptor
    proto_path = 'test/fixtures/proto/addressbook.proto'
  ...
  def test_collision
    assert_raise Protobuf::Message::TagCollisionError do require 'test/fixtures/collision' end
    assert_raise Protobuf::Message::TagCollisionError do 
      Protobuf::Compiler.new.create_message('test/fixtures/proto/collision.proto', '.', '.', false) 
    end
  end

  def test_ext_collision
    assert_raise Protobuf::Message::TagCollisionError do require 'test/fixtures/ext_collision' end
    assert_raise Protobuf::Message::TagCollisionError do 
      Protobuf::Compiler.new.create_message('test/fixtures/proto/ext_collision.proto', '.', '.', false) 
    end
  end

  def test_ext_range
    assert_raise RangeError do require 'test/fixtures/ext_range' end
    assert_raise RangeError do 
      Protobuf::Compiler.new.create_message('test/fixtures/proto/ext_range.proto', '.', '.', false) 
    end
  end
